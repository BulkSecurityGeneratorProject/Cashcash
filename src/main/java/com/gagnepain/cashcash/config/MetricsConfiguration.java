	...
	public static class GraphiteRegistry {
		...
		private void init() {
			if (jHipsterProperties.getMetrics()
				...
				final String graphiteHost = jHipsterProperties.getMetrics()
						.getGraphite()
						.getHost();
				final Integer graphitePort = jHipsterProperties.getMetrics()
						.getGraphite()
						.getPort();
				final String graphitePrefix = jHipsterProperties.getMetrics()
						.getGraphite()
						.getPrefix();
	...
	public static class SparkRegistry {
		...
		private void init() {
			if (jHipsterProperties.getMetrics()
				...
				final String sparkHost = jHipsterProperties.getMetrics()
						.getSpark()
						.getHost();
				final Integer sparkPort = jHipsterProperties.getMetrics()
						.getSpark()
						.getPort();
				final SparkReporter sparkReporter = SparkReporter.forRegistry(metricRegistry)
						.convertRatesTo(TimeUnit.SECONDS)
						.convertDurationsTo(TimeUnit.MILLISECONDS)
