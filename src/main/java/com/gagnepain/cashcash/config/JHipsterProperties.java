...
public class JHipsterProperties {
	...
	public static class Cache {
		...
		public static class Ehcache {
			...
			public void setMaxBytesLocalHeap(final String maxBytesLocalHeap) {
	...
	public static class Mail {
		private String from = "cashcash@localhost";
	...
	public static class Swagger {
		private String title = "cashcash API";

		private String description = "cashcash API documentation";
	...
	public static class Metrics {
		...
		public static class Graphite {
			...
			private String prefix = "cashcash";
