...
public class ManagedUserDTO extends UserDTO {
	...
	public ManagedUserDTO(final Long id, final String login, final String password, final String firstName, final String lastName,
			final String email, final boolean activated, final String langKey, final Set<String> authorities,
