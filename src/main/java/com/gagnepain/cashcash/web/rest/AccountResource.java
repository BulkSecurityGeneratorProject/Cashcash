...
import com.gagnepain.cashcash.web.rest.dto.KeyAndPasswordDTO;
import com.gagnepain.cashcash.web.rest.dto.ManagedUserDTO;
import com.gagnepain.cashcash.web.rest.dto.UserDTO;
...
public class AccountResource {
	...
	@Timed
	public ResponseEntity<?> registerAccount(@Valid @RequestBody final ManagedUserDTO managedUserDTO, final HttpServletRequest request) {
		...
		return userRepository.findOneByLogin(managedUserDTO.getLogin()
				...
				.orElseGet(() -> userRepository.findOneByEmail(managedUserDTO.getEmail())
						...
						.orElseGet(() -> {
							final User user = userService.createUserInformation(managedUserDTO.getLogin(), managedUserDTO.getPassword(),
